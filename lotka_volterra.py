...
if __name__ == '__main__':
    ...
    plot_simulation_results(vary_delta_sims, labels, ptitle, fname)
    ...
    plot_simulation_results(vary_gamma_sims, labels, ptitle, fname)
    ...
    fname = 'LotkaVolterra_VaryTrajectory.png'
    ...
    plot_simulation_results(vary_traj_sims, labels, ptitle, fname)
